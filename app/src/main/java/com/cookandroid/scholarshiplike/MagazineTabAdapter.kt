...
class MagazineTabAdapter(val postlist: ArrayList<Post>) : ListAdapter<Post, MagazineTabAdapter.MagazineViewHolder>(DiffCallbackMagazine) {
    ...
    override fun onBindViewHolder(holder: MagazineTabAdapter.MagazineViewHolder, position: Int) {
